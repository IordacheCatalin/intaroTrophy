...
export class ContactComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder, private securityCodeService: SecurityCodeService) {
  ...
  ngOnInit(): void {
    // Subscribe to value changes of the form to validate security code and form status
  ...
  updateButtonState(): void {
    ...
    const button = document.querySelector('.contact-btn.custom-btn-gn') as HTMLButtonElement;
    if (this.contactForm.valid && securityCodeControl?.value === this.generatedCode) {
